...
public class RoomFrame extends javax.swing.JFrame implements IReceiveMessage{
    ServerListener serverListener;
    /**
     * Creates new form RoomFrame
     */
    public RoomFrame(ServerListener listenServer) {
        initComponents();
        
        setLocationRelativeTo(null);
        this.serverListener = listenServer;
        this.serverListener.setReceive(this);
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try {
            serverListener.sendMessage(21, null);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void btnJoinRoomMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnJoinRoomMouseClicked
        ...
        try {
            if (lstRoom.getSelectedIndex() >= 0) {
                serverListener.sendMessage(20, lstRoom.getSelectedIndex());
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void btnViewRoomMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnViewRoomMouseClicked
        ...
        try {
            if (lstRoom.getSelectedIndex()>=0)
            {
                serverListener.sendMessage(41, lstRoom.getSelectedIndex());
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//                    }
//                });
                String[] s = lstRoom.getItem(Integer.parseInt(msg.getObject().toString())).split(" ");
                new Main(serverListener, s[1]).setVisible(true);
                this.dispose();
                break;
            }
            case 21: {
            ...
            case 22: { //Room nay da full
                ...
                lstRoom.select(0);
                JOptionPane.showMessageDialog(null, "Room is full!", "Error", 1);
                break;
            }
        }
    }
